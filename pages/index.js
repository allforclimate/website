  ...
  <Body>
    <center>
      ...
      <About>
        ...
        <p>
          As a local group you probably don't have the resources to create your
          own non profit with your own bank account. You also probably don't
          want to use your personal bank account to receive donations and manage
          the expenses for your group. We have created a non profit based in
          Brussels that can act as a fiscal sponsor for you (in the eurozone),
          think of it as your financial back office. <br />
        ...
        <p>
          ...
          Climate is set up as a proper non profit entity based in Brussels that
          you can trust. We act as a shared administrative back office so that
          local groups can focus on their actions.
          <br />
